...
const LINKING_ERROR =
  `The package 'react-native-paste-image-input' doesn't seem to be linked. Make sure: \n\n` +
...
const PasteInput: ForwardRefRenderFunction<any, PasteInputProps> = (
  props,
  ref
) => {
  ...
  const _onScroll = (event: NativeSyntheticEvent<TextInputScrollEventData>) => {
...
export default forwardRef(PasteInput);
